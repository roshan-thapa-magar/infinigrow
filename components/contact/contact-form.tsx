            ...
            <div className="mx-auto max-w-7xl px-4 md:px-8">
                ...
                <div className="mb-14 max-w-3xl sm:mb-16">
                    ...
                    <p
                        ...
                        "
                    >
                        Have an idea, project, or challenge in mind? Tell us
                        what you're working on and let's explore how we can
                        ...
                        <div className="space-y-10">
                            ...
                            <div>
                                ...
                                <p
                                    ...
                                    "
                                >
                                    Explore opportunities to work with our
                                    team. We're always interested in meeting
                            ...
                            <div>
                                ...
                                <p
                                    ...
                                    "
                                >
                                    Discover our fellowship opportunities
                                    and find a way to learn, contribute,
                    ...
                    <section className="order-1 lg:order-2">
                        ...
                        <div className="mb-10">
                            ...
                            <p
                                ...
                                "
                            >
                                Answer a few quick questions so we can better
                                understand your goals and connect you with
                                the right people.
                            </p>
                        </div>
                        ...
                        <form className="space-y-9">
                                        ...
                                        >
                                            <RadioGroupItem
                                                ...
                                                className="
                                                    ...
                                                    data-[state=checked]:text-emerald-600
                                                "
                                            />
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-muted-foreground">
                                        Select the service closest to your
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-muted-foreground">
                                        Give us a brief overview of your idea,
                                        goals, timeline, or anything else we
                                        should know.
                                    </p>
                                </div>
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    our team may contact you regarding your
                                    inquiry.
                                </p>
                            </div>
